...
export const UI = {
  zh: {
    ...
    loggedIn: "已登录",
    language: "中文",
    authMessage: "登录后可以提交、查看个人轨迹和使用 AI 解释。",
    ...
    start: "开始",
    graph: "图谱",
    libraryCopy: "支持 LeetCode 风格函数模式和 ACM 标准输入输出模式。",
    previous: "上一页",
    next: "下一页",
    page: "第",
    backLibrary: "返回题库",
    ...
    acmFrame: "ACM 模式：请自己处理标准输入和标准输出。",
    noFunctionFrame: "当前题目没有函数模式模板。",
    functionPythonOnly: "函数模式暂只支持 Python；切回 Python 或使用 ACM 模式。",
    modeFunctionTitle: "点击切换到 ACM 模式。当前只需补全题目给定函数。",
  ...
  en: {
    ...
    start: "Start",
    graph: "Graph",
    libraryCopy: "Practice with LeetCode-style function mode or ACM stdin/stdout mode.",
    previous: "Previous",
    next: "Next",
    page: "Page",
...
const VERDICTS = {
  ...
  ce: {
    zh: ["编译错误", "Compile Error：代码未能通过编译或语言运行前检查。"],
